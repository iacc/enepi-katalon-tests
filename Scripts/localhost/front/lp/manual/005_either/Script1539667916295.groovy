...
WebUI.navigateToUrl(GlobalVariable.domain + '/lp/005/either?pr=katalon_03')

WebUI.waitForElementPresent(findTestObject('front/estimate_form/form'), 30)

WebUI.callTestCase(findTestCase('localhost/front/new_form/contact_manual'), [:], FailureHandling.STOP_ON_FAILURE)
